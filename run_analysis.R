...
## Save the first, non-aggregated file
   write.table(mergedResultsWithActivity_SubjectNumber, file = "/Users/dconway/Documents/Training/Coursera/Getting and Cleaning Data/Wk4/project/DanicaConwayDataSet1.txt", row.names = TRUE)  
   
## Save the file of means
   write.table(meanResults, file = "/Users/dconway/Documents/Training/Coursera/Getting and Cleaning Data/Wk4/project/DanicaConwayMeanResults.txt", row.names = TRUE)               